...
noware::var const & noware::var::operator += (var const & other)
{
	...
	{
		*this = operator std::string const () + other.operator std::string const ();
	}
...
/*
noware::var const noware::var::operator += (unsigned char other [])
{
	return *this += nr (other);
}

noware::var const noware::var::operator += (signed char other [])
{
	return *this += nr (other);
}
*/
